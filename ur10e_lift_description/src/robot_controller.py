#!/usr/bin/env python3
"""
Fixed Robot Controller Node - Uses ROS timers properly
"""
...
class FixedRobotController(Node):
    def __init__(self):
        ...
        # Timer to publish joint states at very high rate
    ...
    def demo_sequence_step(self):
        """Execute one step of the demo sequence"""
        if self.demo_step == 1:
